...
async function main() {
  const villaData = {
    ...
    address: "Geriş Caddesi, 6441 Sokak No:4, Toscana Yalıkavak Sitesi, C Blok Villa 1, Yalıkavak / Bodrum",
    ...
    translations: {
      en: {
        ...
        location: "Yalıkavak, Bodrum",
        address: "Geriş Caddesi, 6441 Sokak No:4, Toscana Yalıkavak Sitesi, Block C, Villa 1, Yalıkavak / Bodrum",
        amenities: [
      ...
      de: {
        ...
        location: "Yalıkavak, Bodrum",
        address: "Geriş Caddesi, 6441 Sokak Nr. 4, Toscana Yalıkavak Sitesi, Block C, Villa 1, Yalıkavak / Bodrum",
        amenities: [
      ...
      ru: {
        ...
        address: "Geriş Caddesi, 6441 Sokak No:4, Toscana Yalıkavak Sitesi, блок C, вилла 1, Ялыкавак / Бодрум",
        amenities: [
      ...
      ar: {
        ...
        address: "شارع غيريش، 6441 سوكاك رقم:4، مجمّع توسكانا يالِكافاك، مبنى C، فيلا 1، يالِكافاك / بودروم",
        amenities: [
